                            ...
                            <Accordion.Item eventKey="3">
                                ...
                                <Accordion.Body>
                                    <div className="button-container">
                                        <Button variant="secondary" className="custom-button">s</Button>
                                        <Button variant="secondary" className="custom-button">x</Button>
                                        <Button variant="secondary" className="custom-button">M</Button>
                                    </div>
                                    <div className="button-container">
                                        <Button variant="secondary" className="custom-button">L</Button>
                                        <Button variant="secondary" className="custom-button">XL</Button>
                                        <Button variant="secondary" className="custom-button">XXL</Button>
                                    </div>
                                </Accordion.Body>
                            </Accordion.Item>
